...
/* Private defines -----------------------------------------------------------*/
#define HALF_Pin GPIO_PIN_1
#define HALF_GPIO_Port GPIOF
#define FULL_Pin GPIO_PIN_2
#define FULL_GPIO_Port GPIOF
#define CENTRAL_Pin GPIO_PIN_3
#define CENTRAL_GPIO_Port GPIOF
...
#define H4_INB_Pin GPIO_PIN_10
#define H4_INB_GPIO_Port GPIOD
#define H4_INA_Pin GPIO_PIN_11
#define H4_INA_GPIO_Port GPIOD
#define H4_PWM_Pin GPIO_PIN_12
#define H4_PWM_GPIO_Port GPIOD
#define H5_PWM_Pin GPIO_PIN_13
#define H5_PWM_GPIO_Port GPIOD
#define H5_INB_Pin GPIO_PIN_14
#define H5_INB_GPIO_Port GPIOD
#define H5_INA_Pin GPIO_PIN_15
#define H5_INA_GPIO_Port GPIOD
